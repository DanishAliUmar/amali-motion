...
const Header = () => {
  ...
  return (
    <div className="grid grid-cols-3 z-[999] p-3 px-10 fixed top-0 left-0 w-screen">
      <p
        className={`bg-black/20 px-5 py-3 rounded-full w-fit ease-in transition-opacity duration-1000 ${
      ...
      <div
        className={`flex items-center justify-end ease-in transition-opacity duration-1000 ${
          isLoading ? 'opacity-0' : 'opacity-100'
        }`}
      >
